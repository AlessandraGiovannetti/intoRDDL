...
if __name__ == "__main__":
    mdp = MDPDiscovery(dataset="permit_preprocessed", k=10, state_abstraction="partial_k_means")
    ...
    transitions.to_csv("./src/output/permit/mdp_transitions.csv", index=False)
    ...
    states.to_csv("./src/output/permit/mdp_states.csv", index=False)
    print("Salvato in mdp_states.csv")"""

    state_descriptions = mdp.describe_states()
    state_descriptions.to_csv("./src/output/permit/mdp_states_described.csv", index=False)
